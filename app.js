...
submit.addEventListener("click", (e) => {
  ...
  if (username.value === "") {
    ...
    showMessage(usernameMessage, "Great Name", "#7289da");
  }

  if (email.value === "") {
    showMessage(emailMessage, "Please Provide Your Email", "#FF0000");
  } else {
    showMessage(emailMessage, "Got your email", "#7289da");
  }

  if (password1.value === "") {
    showMessage(password1Message, "Please Provide Your Password", "#FF0000");
  } else {
    showMessage(password1Message, "Valid password", "#7289da");
  }
  ...
  if (password2.value === "") {
    ...
    showMessage(password2Message, "Valid password", "#7289da");
  }
});
